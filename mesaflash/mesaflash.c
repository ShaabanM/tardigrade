        ...
        switch (c) {
            ...
            case 'r': {
                ...
                if (strncmp(optarg, "0x", 2) == 0) {
                    optarg[0] = '0';
                    optarg[1] = '0';
                    rpo_addr = strtoul(optarg, NULL, 16);
                } else {
                    rpo_addr = strtoul(optarg, NULL, 10);
                }
                rpo_flag++;
            }
            break;
            ...
            case 'o': {
                ...
                if (strncmp(pch, "0x", 2) == 0) {
                    pch[0] = '0';
                    pch[1] = '0';
                    wpo_addr = strtoul(pch, NULL, 16);
                } else {
                    wpo_addr = strtoul(pch, NULL, 10);
                }
                pch = strtok(NULL, "=");
                if (strncmp(pch, "0x", 2) == 0) {
                    pch[0] = '0';
                    pch[1] = '0';
                    wpo_data = strtoul(pch, NULL, 16);
                } else {
                    wpo_data = strtoul(pch, NULL, 10);
                }
                wpo_flag++;
            }
            break;
