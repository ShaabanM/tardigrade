...
subprocess.Popen([sys.executable,os.path.abspath('../SMRT/py_src/test_ram.py'),str(the_dir)], stdin=None, stdout=None, stderr=None)
time.sleep(1)

subprocess.Popen([sys.executable,os.path.abspath('../SMRT/py_src/test_cpu.py'),str(the_dir)], stdin=None, stdout=None, stderr=None)
time.sleep(1)

subprocess.Popen([sys.executable,os.path.abspath('test_disks.py'),str(the_dir)], stdin=None, stdout=None, stderr=None)
time.sleep(1)

subprocess.Popen([sys.executable,os.path.abspath('../SMRT/py_src/test_networks.py'),str(the_dir)], stdin=None, stdout=None, stderr=None)
time.sleep(1)

run_cams = False        #adds the ability to test attached cameras.  Feature incomplete.
if 'linux' in sys.platform:
    if run_cams == True:
        subprocess.Popen([sys.executable,os.path.abspath('../SMRT/py_src/test_pi_cam.py'),str(the_dir)], stdin=None, stdout=None, stderr=None)
        time.sleep(1)
